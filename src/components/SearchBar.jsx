...
const SearchBar = () => {
  ...
  const filterSearchData = searchData
    .filter((obj) =>
      obj.name.toLowerCase().includes(search.toLocaleLowerCase())
    )
    .slice(0, 8);
    ...
    <div className="">
      ...
      <div className="input flex justify-center">
        <input
          ...
          className=" bg-gray-100 placeholder-gray-400 rounded-lg px-1 py-1 h-7 w-66 lg:w-66 md:w-66 outline-none text-black "
        />
      </div>
      ...
      <div className=" flex justify-center">
        {search && (
          <div className="block absolute bg-gray-200 w-66 md:w-66 lg:w-46 z-50 my-1 rounded-lg px-2 py-2">
